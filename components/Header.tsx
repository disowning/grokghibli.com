      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Button className="ml-4 bg-gradient-to-r from-ghibli-primary to-ghibli-secondary hover:from-ghibli-secondary hover:to-ghibli-primary transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
              Try Now
            </Button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 space-y-3">
            ...
            <div className="pt-2">
              <Button className="w-full bg-gradient-to-r from-ghibli-primary to-ghibli-secondary hover:from-ghibli-secondary hover:to-ghibli-primary transition-all duration-300 shadow-md">
                Try Now
              </Button>
            </div>
          </div>
